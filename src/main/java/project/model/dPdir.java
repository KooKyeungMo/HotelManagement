...
public class dPdir {
    ...
    private SimpleStringProperty howPerson;
    ...
    public dPdir(String resno, String resname, String resroom, String checkIn, String checkOut, String payMent, String damDang,
        ...
        this.howPerson = new SimpleStringProperty(howPerson);
    }

    public String getHowPerson() {
        return howPerson.get();
    }

    public SimpleStringProperty howPersonProperty() {
        return howPerson;
    }

    public void setHowPerson(String howPerson) {
        this.howPerson.set(howPerson);
    }
